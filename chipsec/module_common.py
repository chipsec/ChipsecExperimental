...
class BaseModule(object):
    ...
    def is_unsupported_platform(self, unsupported):
        if self.cs.get_chipset_code() in unsupported:
            self.logger.log_information('Platform {} is not supported'.format(self.cs.get_chipset_code()))
            return True
        return False
